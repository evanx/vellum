...
On that subject, also see <a href="https://github.com/evanx/vellum/keyserver">keyserver</a> - a re-implementation of `dualcontrol` in Node.js, and additionally provides a secure "vault" server which uses Redis to store encryption keys (protected by split-knowledge passwords) and encrypted data.
